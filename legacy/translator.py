...
from db import salvar_traducao, obter_traducao, listar_traducoes_documento
...
class TradutorComPersistencia:
    ...
    def traduzir_e_salvar(self, documento_id: int, texto: str, 
                          destino: str = 'en') -> dict:
        """
        ...
        # Traduzir
        resultado = self.translator.traduzir_documento_completo(
            texto, 
            destino=destino
        )
