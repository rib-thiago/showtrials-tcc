...
- documentacao viva de projeto, como README, changelog e guias em `docs/flows/`
...
- consultar [Politica de Governanca do Projeto](politica_de_governanca.md) e os protocolos correlatos quando a atualizacao documental afetar fluxo operacional ou criterios normativos
