...
Quando a mudanca envolver automacao, telemetria, depuracao, refatoracao ou movimentacao de status no Project, este guia deve ser complementado pelos documentos especificos do bloco `docs/flows/`.
