...
- drivers já formalizados em [17_drivers_arquiteturais.md](/home/thiago/coleta_showtrials/docs/modelagem/17_drivers_arquiteturais.md) foram reconectados à base de requisitos em nível de bloco, e não de requisito unitário
