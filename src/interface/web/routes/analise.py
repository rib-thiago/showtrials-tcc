...
async def analisar_acervo(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse(
            "analise/acervo.html", {"request": request, "stats": stats}
        )
    except Exception as e:
        return templates.TemplateResponse(
            "erro.html",
            {"request": request, "mensagem": f"Erro na análise do acervo: {str(e)}", "voltar": "/"},
            status_code=500,
        )
...
async def analisar_documento_form(request: Request, documento_id: int):
    ...
    """
    return templates.TemplateResponse(
        "analise/form.html", {"request": request, "documento_id": documento_id}
    )
...
async def analisar_documento(
    ...
    try:
        resultado = use_case.executar(
            documento_id=documento_id, idioma=idioma, gerar_wordcloud=gerar_wordcloud
        )
        ...
        return templates.TemplateResponse(
            ...
            {"request": request, "analise": resultado, "documento_id": documento_id},
        )
    except Exception as e:
        return templates.TemplateResponse(
            "erro.html",
